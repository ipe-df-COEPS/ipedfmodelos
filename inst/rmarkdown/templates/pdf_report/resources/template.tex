...
\usepackage[T1]{fontenc}    	  % for coding output; allows for umlaut, accents und
                          		  % correct hyphenation
\usepackage[nportuges]{babel}     % Portuguese so that captions, toc and all is NOT in English
$endif$
...
\definecolor{linkcol}{HTML}{0271BB} %lightblue
\definecolor{filecol}{HTML}{b70000} %darkred
\definecolor{urlcol}{HTML}{b70000} %darkred
\definecolor{citecol}{HTML}{0271BB} %lightblue
% }}}
...
% Custom colors {{{
\definecolor{bluegray}{HTML}{3B515B} % HTML stands for hexdecimal coding
\definecolor{blue}{HTML}{0271BB}
% }}}


% Sections {{{
\titleformat{\section}{\color{blue}\headingfont\Large\bfseries}{\thesection}{1em}{}[\titlerule]
\titleformat{\subsection}{\color{bluegray}\headingfont\large\bfseries}{\thesubsection}{1em}{}
\titleformat{\subsubsection}{\color{bluegray}\headingfont\bfseries}{\thesubsubsection}{1em}{}
% }}}
