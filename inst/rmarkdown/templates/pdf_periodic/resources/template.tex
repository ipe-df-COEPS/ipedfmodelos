...
%              \draw (#1*#4,0) --+ (0,#2);
        ...
        \begin{tikzpicture}
        \pic[rounded corners=0.5cm] (B) at (0.5,-4) {tricolor={5}{3}{0.33}{0.67}{gray!80}{gray!80}{gray!80}};
        \node at (B-left)   {};
      \node at (B-middle) {\huge  \color{bluegray}$reportnumber$};
        \node at (B-right)  {  $if(author)$
...
%              \draw (#1*#4,0) --+ (0,#2);
  ...
  \begin{tikzpicture}
  \pic[rounded corners=0.5cm] (B) at (0.5,-4) {tricolor={19}{1}{0.33}{0.67}{bluegray!80}{bluegray!80}{bluegray!80}};
   \node at (B-right)  {};
  \end{tikzpicture}
  \end{minipage}\hfill
\end{center}
