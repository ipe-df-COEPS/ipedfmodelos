...
%              \draw (#1*#4,0) --+ (0,#2);
        ...
        \begin{tikzpicture}
        \pic[rounded corners=0.5cm] (B) at (0.5,-4) {tricolor={5}{3}{0.33}{0.67}{blue!80}{blue!80}{blue!80}};
        \node at (B-left)   {};
      \node at (B-middle) {\huge  \color{bluegray}$reportnumber$};
        \node at (B-right)  {};
        \end{tikzpicture}
...
%              \draw (#1*#4,0) --+ (0,#2);
  ...
  \begin{tikzpicture}
  \pic[rounded corners=0.5cm] (C) at (0.5,-4) {tricolor={19}{1}{0.33}{0.67}{bluegray!80}{bluegray!80}{bluegray!80}};
    \node at {C-left} {$if(author)$
  \large\color{bluegray} $author$\par
  $endif$};
   \node at {C-right}  {\color{white}\@date};
  \end{tikzpicture}
  \end{minipage}\hfill
\end{center}
