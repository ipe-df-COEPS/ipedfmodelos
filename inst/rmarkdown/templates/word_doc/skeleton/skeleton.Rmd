...
widdth(ht) <- 1
font_size(ht) <- 10
caption(ht) <- "Visão geral das primeiras linhas e colunas no conjunto de dados cnes."
...
plot(cnes$hp, cnes$mpg,
xlab = "Potência Bruta",
ylab = "Milhas por galão",
pc = 19)
abline(lm(mpg ~ hp, data = cnes), col = "red")
```
