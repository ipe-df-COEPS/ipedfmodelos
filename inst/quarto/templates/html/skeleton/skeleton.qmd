...
author:
  - name: Author name 
    url: https://www.ipe.df.gov.br
    affiliation: IPE-DF
    affiliation-url: https://www.ipe.df.gov.br
citation:
  url: https://example.com/summarizing-output
license: "CC BY-SA" 
### Uncomment the following line if the document language is English
...
format: 
  html:
    ...
    toc-depth: 3
    toc-location: left
    toc-title: Contents   # remove line or adjust if language is English
    ...
    crossref: 
      ...
      fig-prefix: Fig.    # (default is 'Figure'; adjust if language is English)
    # Code options:
