...
logo1: images/ipedf_logo.png  # logo on left side of title page
...
The default font for this template is 'Lato' but can be replaced with 'Georgia' font. You can choose the font in the template when running the function, e.g., `ipedfmodelos::create_quarto_doc(dirname = "your_pdf_report, template = "pdf_report", font = "Georgia")`.
