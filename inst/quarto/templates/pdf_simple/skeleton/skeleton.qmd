...
The default font for this template is 'Lato' but can be replaced with the font 'Georgia'. You can choose the font in the template when running the function, e.g., `ipedfmodelos::create_quarto_doc(dirname = "pdf_simple_doc", template = "pdf_simple", font = "Georgia")`.
