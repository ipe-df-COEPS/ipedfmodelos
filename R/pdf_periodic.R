#' Convert to periodic PDF/LaTeX report/bulleting in Portuguese (pt)
#'
...
#'   \item \code{reportnumber} The number (manually set).
...
#' @export
#'
pdf_periodic <- function(number_sections = TRUE, highlight = "kate",
  ...
  if (font %in% c("Lato", "Georgia")) {
    copy_font_files("pdf_periodic", font)
  }
